...
const { asignacion, DestroyAsignaciones } = require('../controller/Roles-users.controller');
...
router.post("/roles/asignaciones", [checkAuth ], asignacion);
// router.delete("/roles/asignaciones/:id", [checkAuth ], DestroyAsignaciones  );
